package com.rxora.app.voice.recorder

import android.annotation.SuppressLint
import android.media.AudioFormat
import android.media.AudioRecord
import android.media.MediaRecorder
import com.rxora.app.voice.media.encodeWaveFile
            ...
            try {
                ...
                while (!quit.get()) {
                    ...
                    if (read > 0) {
                        ...
                        throw java.lang.RuntimeException("audioRecord.read returned error code $read")
                    }
                }
